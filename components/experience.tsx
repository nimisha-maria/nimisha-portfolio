  ...
  return (
    <section id="experience" className="relative mx-auto max-w-6xl px-6 py-28">
      <SectionHeading
        ...
        title="Building real world development skills."
        description="Structured professional training focused on full-stack development and Generative AI."
      />
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-3">
                <h3 className="font-display text-2xl font-bold text-foreground">
                  Java Full Stack Developer — Professional Training
                </h3>
              ...
              <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground text-pretty">
                Ongoing professional training in Java Full Stack Development with
                hands-on learning across Java, Spring Boot, REST APIs, databases,
                React, and modern web development, with additional focus on
                Generative AI and AI-powered application development.
              </p>
            </div>
          </div>
        </article>
